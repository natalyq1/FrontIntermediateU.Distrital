function alerta() {
  ...
  // Asocia un evento a un elemento NO SE ESCRIBEN LOS PARÉNTESIS DE LA FUNCIÓN*************************
  ...
  const tituloFecha2 = document.getElementById("tituloFecha2");
  tituloFecha2.addEventListener("click", function () {
    console.log("Hello 1");
  });
