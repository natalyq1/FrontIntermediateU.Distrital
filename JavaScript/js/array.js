//estaticas de tantos elementos y dinamicas con multiples elementos y pueden ir variando

//elementos con valores inicializados y difts. tipos de datos
let arrayElementos = [10, 20, 3.4, 'Catalina', true]
console.log(`${arrayElementos}`)

//tipo de valor
console.log(typeof arrayElementos)
//obtener un valor en especifico
console.log(arrayElementos[2])
//cambiar el valor de un elemento
arrayElementos[1] = 500
console.log(arrayElementos)

//copia de una arreglo
let aant = 5 //aant --> 5
let bent = aant //bent -->5
aant = 6 //a --> 6
console.log(aant, bent)

//con arreglo
let arreglo = [1, 2, 3]
let copiando = arreglo //no se debe hacer
arreglo.pop()
console.log(arreglo) //[1, 2]
console.log(copiando) //[1, 2]

//con arreglo
console.log('--si se debe hacer--')
let empieza = [1, 2, 3]
let copy = empieza
empieza = [4, 6, 8, 9]
empieza.pop()
...
let copy1 = [...empieza] //operador SPREAD--> permite extraer los datos de un elemento
empieza.push(7)
console.log('arreglo', empieza) //arreglo (4) [4, 6, 8, 7]
console.log('copy', copy1) // [4, 6, 8]
